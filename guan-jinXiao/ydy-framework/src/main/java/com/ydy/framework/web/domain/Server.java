package com.ydy.framework.web.domain;

import java.net.UnknownHostException;
import java.util.LinkedList;
import java.util.List;
import java.util.Properties;
import com.ydy.common.utils.Arith;
import com.ydy.common.utils.ip.IpUtils;
import com.ydy.framework.web.domain.server.Cpu;
import com.ydy.framework.web.domain.server.Jvm;
import com.ydy.framework.web.domain.server.Mem;
import com.ydy.framework.web.domain.server.Sys;
import com.ydy.framework.web.domain.server.SysFile;
